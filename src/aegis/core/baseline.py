"""
Aegis Core Baseline Manager.
Manages grandfathered technical debt ledgers in .aegis/baseline.json.
Thread-safe with atomic writes. Zero agent-framework dependencies.
"""
...
from aegis.core.registry import ArchitecturalViolation, Rule, RuleCategory
