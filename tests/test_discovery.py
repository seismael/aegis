...
async def test_discover_architectural_patterns_structured(tmp_path):
    ...
    assert security_proposal.suggested_action == "apply_governance_law(law_id='security')"
    ...
    assert arch_proposal.suggested_action == "apply_governance_law(law_id='architecture')"
